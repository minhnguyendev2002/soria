...
(function () {
    let a; let b; let c; const d = function (a, b) {
        return function () {
            ...
            return a.prototype.get = function (a) {
                ...
                a.prototype.set = function (a, b) {
                    ...
                    for (g = this.keys,
                        ...
                        f = g.length; f > e; c = ++e) {
                        if (d = g[c],
                            d === a) { return void (this.values[c] = b); }
                    }
            ...
            return f.prototype.defaults = {
                ...
                f.prototype.init = function () {
                    ...
                    return this.element = window.document.documentElement,
                        (a = document.readyState) === 'interactive' || a === 'complete' ? this.start() : document.addEventListener('DOMContentLoaded', this.start),
                        this.finished = [];
                }
                ,
                ...
                f.prototype.doSync = function (a) {
                    let b; let c; let d; let f; let
                        g;
                    if (!this.stopped) {
                        if (a == null && (a = this.element),
                            a.nodeType !== 1) { return; }
                ...
                f.prototype.vendorCSS = function (a, b) {
                    let c; let d; let e; let f; let g; let
                        h;
