<template>
    <div>
        <div class="page-wrapper">
            ...
            <div class="hidden-bar-back-drop" />
                ...
                <div class="auto-container">
                    <div class="upper-box">
                        <div class="sec-title">
                            <div class="row">
                                <div class="col-lg-6">
                                    <span class="float-text">brand</span>
                                    <h2>We’ve More Then 254+ <br>Global Partners</h2>
                                </div>
                                <div class="col-lg-6">
                                    <div class="text">
                                        Sed ut perspiciatis unde omnis natus error voluptatem santium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab nllo inventore veritatis quasi architecto beatae vitae
                        ...
                        <div class="features-column col-lg-8 col-md-12 col-sm-12">
                            <div class="inner-column wow fadeInRight">
                                <div class="sec-title">
                                    ...
                                    <h2>Explore Our Professional <br>Business Solutions</h2>
                                </div>

                                <div class="row">
                                    <!-- Feature Block -->
                                    <div class="feature-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                                        <div class="inner-box ">
                                            <div class="content">
                                                <figure class="icon">
                                    ...
                                    <!-- Service Block -->
                                    <div class="feature-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                                        <div class="inner-box ">
                                            <div class="content">
                                                <figure class="icon">
                                    ...
                                    <!-- Service Block -->
                                    <div class="feature-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
                                        <div class="inner-box ">
                                            <div class="content">
                                                <figure class="icon">
                                    ...
                                    <!-- Service Block -->
                                    <div class="feature-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="900ms">
                                        <div class="inner-box ">
                                            <div class="content">
                                                <figure class="icon">
            ...
            <section class="about-section">
                <div class="bg bg-pattern-1" />
                <div class="anim-icons">
                    <span class="icon icon-circle-1 bounce-y" />
                    <span class="icon icon-circle-2 bounce-x" />
                    <span class="icon icon-star zoom-one" />
                </div>
                <div class="auto-container">
                    <div class="row">
                        <div class="content-column col-xl-6 col-lg-7 col-md-12 col-sm-12 wow fadeInRight">
                            <div class="inner-column">
                                <div class="sec-title light">
                                    ...
                                    <h2>We’re Awards Winning Modern Business Solutions Agency</h2>
                                    <div class="text">
            ...
            <section class="services-section">
                <div class="auto-container">
                    <div class="sec-title text-center">
                        ...
                        <h2>Great Features To Do Your Buisness <br>Growth & Development</h2>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="services-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column">
                                <!-- Service Block -->
                                <div class="service-block wow fadeInRight">
                                    <div class="inner-box">
                                        <div class="content">
                                            <figure class="icon">
                                ...
                                <!-- Service Block -->
                                <div class="service-block wow fadeInRight" data-wow-delay="300ms">
                                    <div class="inner-box">
                                        <div class="content">
                                            <figure class="icon">
                                ...
                                <!-- Service Block -->
                                <div class="service-block wow fadeInRight" data-wow-delay="600ms">
                                    <div class="inner-box">
                                        <div class="content">
                                            <figure class="icon">
                                ...
                                <!-- Service Block -->
                                <div class="service-block wow fadeInRight" data-wow-delay="900ms">
                                    <div class="inner-box">
                                        <div class="content">
                                            <figure class="icon">
                                ...
                                <!-- Service Block -->
                                <div class="service-block wow fadeInRight" data-wow-delay="1200ms">
                                    <div class="inner-box">
                                        <div class="content">
                                            <figure class="icon">
            ...
            <section class="fun-fact-section">
                <div class="outer-box">
                    ...
                    <div class="anim-icons">
                        ...
                        <span class="icon icon-object-1 bounce-x" />
                        <span class="icon icon-object-2 bounce-y" />
                    </div>
                    <div class="auto-container">
            ...
            <section class="pricing-section pull-up">
                ...
                <div class="auto-container">
                    <div class="sec-title text-center">
                        ...
                        <h2>Amazing Pricing Package For <br>Professional Solutions</h2>
                    </div>

                    <div class="row">
                        <!-- Pricing Block -->
                        <div class="pricing-block col-lg-6 col-md-12 col-sm-12 wow fadeInUp">
                            <div class="inner-box">
                                <div class="title-box">
                                    <h6 class="title">
                                        Regular Plan
                                    ...
                                    <div class="testimonial-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="content-box">
                                                ...
                                                <div class="text">
                                                    Sed ut perspiciatis unde natus error sit voluptatem accusantium
                                                    laudant totam aperiam eaque abillo inventore veritatis et quasi architecto
                                                    beatae vitae
                                                </div>
                                                <div class="info-box">
            ...
            <section class="news-section pt-0">
                <div class="auto-container">
                    <div class="sec-title text-center">
                        ...
                        <h2>Learn More Information to Read <br>Our News & Blog</h2>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <div class="post-info">
                                        <span class="cat">UI/UX Strategy</span>
                                        <span class="date"><i class="far fa-calendar" /> Nov 25, 2023</span>
                                    </div>
                                    <h3 class="title">
                                        <a href="news-details.html">Voice Control Usability Consie Ways Partially Visually Hidden</a>
                                    </h3>
                        ...
                        <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <div class="post-info">
                                        <span class="cat">Branding Design</span>
                                        <span class="date"><i class="far fa-calendar" /> Nov 25, 2023</span>
                                    </div>
                                    <h3 class="title">
                                        <a href="news-details.html">Manage Design System Theme With CSS Color-Contrast Balanced</a>
                                    </h3>
                                    <div class="author-box">
                                        <figure class="thumb">
            ...
            <footer class="main-footer">
                ...
                <div class="anim-icons">
                    ...
                    <span class="icon icon-circle-2 bounce-x" />
                    <span class="icon icon-object-3 bounce-y" />
                    <span class="icon icon-object-4 bounce-y" />
                </div>
                <!--Widgets Section-->
                        ...
                        <div class="row">
                            ...
                            <div class="footer-column col-xl-4 col-lg-12 col-md-12">
                                <div class="footer-widget newsletter-widget">
                                    ...
                                    <div class="subscribe-form">
                                        <h4 class="title">
                                            Get Every Single Update to <br>Join Our Newsletter
                                        </h4>
                            ...
                            <div class="footer-column col-xl-3 col-lg-4 col-md-6">
                                <div class="footer-widget">
                                    ...
                                    <ul class="user-links">
                                        <li>785 Main Street, 2nd Block melbourne, australia</li>
                                        <li><a href="mailto:support@gmail.com">support@gmail.com</a></li>
                                        <li><a href="tel:+00012345688">+000 (123) 456 88</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="auto-container">
                        <div class="inner-container">
                            <div class="copyright-text">
                                Copy@ 2023 <a href="index.html">Roket.</a> All Rights reserved
                            </div>
