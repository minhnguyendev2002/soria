!(function (t, e) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e(require('@popperjs/core')) : typeof define === 'function' && define.amd ? define(['@popperjs/core'], e) : (t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = e(t.Popper);
}(this, ((t) => {
    function e(t) {
    ...
    const i = {
        ...
        parents(t, e) {
            const s = [];
            let i = t.parentNode;
            for (; i && i.nodeType === Node.ELEMENT_NODE && i.nodeType !== 3;) {
    ...
    const c = (t) => !(!t || typeof t !== 'object') && (void 0 !== t.jquery && (t = t[0]),
    void 0 !== t.nodeType);
    const h = (t) => (c(t) ? t.jquery ? t[0] : t : typeof t === 'string' && t.length > 0 ? i.findOne(t) : null);
    const d = (t, e, s) => {
        Object.keys(s).forEach((i) => {
            const n = s[i];
            const o = e[i];
            const r = o && c(o) ? 'element' : (a = o) == null ? `${a}` : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase();
            let a;
            if (!new RegExp(n).test(r)) throw new TypeError(`${t.toUpperCase()}: Option "${i}" provided type "${r}" but expected type "${n}".`);
        });
    };
    const u = (t) => !(!c(t) || t.getClientRects().length === 0) && getComputedStyle(t).getPropertyValue('visibility') === 'visible';
    const g = (t) => !t || t.nodeType !== Node.ELEMENT_NODE || !!t.classList.contains('disabled') || (void 0 !== t.disabled ? t.disabled : t.hasAttribute('disabled') && t.getAttribute('disabled') !== 'false');
    const p = (t) => {
    ...
    const b = [];
    const v = () => document.documentElement.dir === 'rtl';
    const y = (t) => {
        let e;
        e = () => {
            const e = _();
    ...
    const A = (t, e, s, i) => {
        let n = t.indexOf(e);
        if (n === -1) return t[!s && i ? t.length - 1 : 0];
        const o = t.length;
        return n += s ? 1 : -1,
        i && (n = (n + o) % o),
    ...
    function j(t, e, s, i, n) {
        ...
        const l = x(t);
        const c = l[a] || (l[a] = {});
        const h = M(c, r, o ? s : null);
        if (h) return void (h.oneOff = h.oneOff && n);
        const d = S(r, e.replace(T, ''));
        const u = o ? (function (t, e, s) {
            return function i(n) {
    ...
    const B = {
        ...
        trigger(t, e, s) {
            ...
            const o = e !== n;
            const r = N.has(n);
            let a; let l = !0; let c = !0; let h = !1; let
                d = null;
    ...
    const W = {
        set(t, e, s) {
            $.has(t) || $.set(t, new Map());
            const i = $.get(t);
            i.has(e) || i.size === 0 ? i.set(e, s) : console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(i.keys())[0]}.`);
        },
    ...
    class z extends q {
        ...
        close(t) {
            ...
            const s = this._triggerCloseEvent(e);
            s === null || s.defaultPrevented || this._removeElement(e);
        }
    ...
    class et extends q {
        ...
        _addEventListeners() {
            ...
            this._config.pause === 'hover' && (B.on(this._element, 'mouseenter.bs.carousel', (t) => this.pause(t)),
        ...
        _addTouchEventListeners() {
            const t = (t) => {
                !this._pointerEvent || t.pointerType !== 'pen' && t.pointerType !== 'touch' ? this._pointerEvent || (this.touchStartX = t.touches[0].clientX) : this.touchStartX = t.clientX;
            };
            const e = (t) => {
                this.touchDeltaX = t.touches && t.touches.length > 1 ? 0 : t.touches[0].clientX - this.touchStartX;
            };
            const s = (t) => {
                !this._pointerEvent || t.pointerType !== 'pen' && t.pointerType !== 'touch' || (this.touchDeltaX = t.clientX - this.touchStartX),
                this._handleSwipe(),
        ...
        _triggerSlideEvent(t, e) {
            ...
            const n = this._getItemIndex(i.findOne('.active.carousel-item', this._element));
        ...
        _slide(t, e) {
            ...
            const n = i.findOne('.active.carousel-item', this._element);
            const o = this._getItemIndex(n);
            const r = e || this._getItemByOrder(s, n);
            const a = this._getItemIndex(r);
            const l = Boolean(this._interval);
            const c = s === Y;
            const h = c ? 'carousel-item-start' : 'carousel-item-end';
            const d = c ? 'carousel-item-next' : 'carousel-item-prev';
            const u = this._orderToDirection(s);
        ...
        static carouselInterface(t, e) {
            ...
            const n = typeof e === 'string' ? e : i.slide;
        ...
        static dataApiClickHandler(t) {
            ...
            const i = this.getAttribute('data-bs-slide-to');
            i && (s.interval = !1),
    ...
    class nt extends q {
        constructor(t, e) {
            ...
            for (let t = 0, e = s.length; t < e; t++) {
                const e = s[t];
                const n = r(e);
                const o = i.find(n).filter((t) => t === this._element);
                n !== null && o.length && (this._selector = n,
        ...
        show() {
            ...
            let t; let
                e;
            this._parent && (t = i.find('.show, .collapsing', this._parent).filter((t) => (typeof this._config.parent === 'string' ? t.getAttribute('data-bs-parent') === this._config.parent : t.classList.contains('collapse'))),
            t.length === 0 && (t = null));
            const s = i.findOne(this._selector);
            if (t) {
                const i = t.find((t) => s !== t);
                if (e = i ? nt.getInstance(i) : null,
                e && e._isTransitioning) return;
            }
        ...
        static collapseInterface(t, e) {
            ...
            if (!s && i.toggle && typeof e === 'string' && /show|hide/.test(e) && (i.toggle = !1),
            s || (s = new nt(t, i)),
            typeof e === 'string') {
    ...
    B.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]', (function (t) {
        ...
        i.find(s).forEach((t) => {
            ...
            let i;
            s ? (s._parent === null && typeof e.parent === 'string' && (s._config.parent = e.parent,
    ...
    const rt = v() ? 'top-end' : 'top-start';
    const at = v() ? 'top-start' : 'top-end';
    const lt = v() ? 'bottom-end' : 'bottom-start';
    const ct = v() ? 'bottom-start' : 'bottom-end';
    const ht = v() ? 'left-start' : 'right-start';
    const dt = v() ? 'right-start' : 'left-start';
    const ut = {
        offset: [0, 2],
    ...
    class pt extends q {
        ...
        show() {
            ...
            if (!B.trigger(this._element, 'show.bs.dropdown', e).defaultPrevented) {
                if (this._inNavbar) V.setDataAttribute(this._menu, 'popper', 'none');
                    ...
                    let e = this._element;
                    this._config.reference === 'parent' ? e = t : c(this._config.reference) ? e = h(this._config.reference) : typeof this._config.reference === 'object' && (e = this._config.reference);
                    const i = this._getPopperConfig();
                    const n = i.modifiers.find((t) => t.name === 'applyStyles' && !1 === t.enabled);
        ...
        _getConfig(t) {
            ...
            typeof t.reference === 'object' && !c(t.reference) && typeof t.reference.getBoundingClientRect !== 'function') throw new TypeError(`${'dropdown'.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
            return t;
        }
        ...
        _selectMenuItem({ key: t, target: e }) {
            ...
            s.length && A(s, e, t === 'ArrowDown', !s.includes(e)).focus();
        }
        ...
        static clearMenus(t) {
            ...
            for (let s = 0, i = e.length; s < i; s++) {
                ...
                if (t) {
                    ...
                    const s = e.includes(i._menu);
                    if (e.includes(i._element) || i._config.autoClose === 'inside' && !s || i._config.autoClose === 'outside' && s) continue;
                    if (i._menu.contains(t.target) && (t.type === 'keyup' && t.key === 'Tab' || /input|select|option|textarea|form/i.test(t.target.tagName))) continue;
                    t.type === 'click' && (n.clickEvent = t);
                }
                i._completeHide(n);
            }
        }
        ...
        static dataApiKeydownHandler(t) {
            if (/input|textarea/i.test(t.target.tagName) ? t.key === 'Space' || t.key !== 'Escape' && (t.key !== 'ArrowDown' && t.key !== 'ArrowUp' || t.target.closest('.dropdown-menu')) : !ot.test(t.key)) return;
            const e = this.classList.contains('show');
            if (!e && t.key === 'Escape') return;
            if (t.preventDefault(),
            t.stopPropagation(),
            g(this)) return;
            const s = () => (this.matches('[data-bs-toggle="dropdown"]') ? this : i.prev(this, '[data-bs-toggle="dropdown"]')[0]);
            return t.key === 'Escape' ? (s().focus(),
            void pt.clearMenus()) : t.key === 'ArrowUp' || t.key === 'ArrowDown' ? (e || s().click(),
            void pt.getInstance(s())._selectMenuItem(t)) : void (e && t.key !== 'Space' || pt.clearMenus());
        }
    }
    ...
    class wt extends q {
        ...
        _showElement(t) {
            const e = this._isAnimated();
            const s = i.findOne('.modal-body', this._dialog);
        ...
        _setEscapeEvent() {
            this._isShown ? B.on(this._element, 'keydown.dismiss.bs.modal', (t) => {
                this._config.keyboard && t.key === 'Escape' ? (t.preventDefault(),
                this.hide()) : this._config.keyboard || t.key !== 'Escape' || this._triggerBackdropTransition();
        ...
        _showBackdrop(t) {
            B.on(this._element, 'click.dismiss.bs.modal', (t) => {
                this._ignoreBackdropClick ? this._ignoreBackdropClick = !1 : t.target === t.currentTarget && (!0 === this._config.backdrop ? this.hide() : this._config.backdrop === 'static' && this._triggerBackdropTransition());
            }),
        ...
        _triggerBackdropTransition() {
            ...
            const i = e > document.documentElement.clientHeight;
            !i && s.overflowY === 'hidden' || t.contains('modal-static') || (i || (s.overflowY = 'hidden'),
            t.add('modal-static'),
            this._queueCallback(() => {
    ...
    const kt = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i;
    const Lt = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i;
    const Ot = (t, e) => {
    ...
    const Nt = new Set(['sanitize', 'allowList', 'sanitizeFn']);
    const St = {
        animation: 'boolean',
        template: 'string',
    ...
    class jt extends q {
        ...
        show() {
            ...
            const e = p(this._element);
            const i = e === null ? this._element.ownerDocument.documentElement.contains(this._element) : e.contains(this._element);
            if (t.defaultPrevented || !i) return;
            const o = this.getTipElement();
            const r = n(this.constructor.NAME);
            o.setAttribute('id', r),
            this._element.setAttribute('aria-describedby', r),
            this.setContent(),
            this._config.animation && o.classList.add('fade');
            const a = typeof this._config.placement === 'function' ? this._config.placement.call(this, o, this._element) : this._config.placement;
            ...
            const h = typeof this._config.customClass === 'function' ? this._config.customClass() : this._config.customClass;
        ...
        hide() {
            ...
            this._queueCallback(() => {
                this._isWithActiveTrigger() || (this._hoverState !== 'show' && t.remove(),
                this._cleanTipClass(),
        ...
        getTitle() {
            ...
            return t || (t = typeof this._config.title === 'function' ? this._config.title.call(this._element) : this._config.title),
            t;
        }
        ...
        _setListeners() {
            this._config.trigger.split(' ').forEach((t) => {
                if (t === 'click') B.on(this._element, this.constructor.Event.CLICK, this._config.selector, (t) => this.toggle(t));
                else if (t !== 'manual') {
                    const e = t === 'hover' ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN;
                    const s = t === 'hover' ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
        ...
        _fixTitle() {
            ...
            (t || e !== 'string') && (this._element.setAttribute('data-bs-original-title', t || ''),
        ...
        _enter(t, e) {
            ...
            t && (e._activeTrigger[t.type === 'focusin' ? 'focus' : 'hover'] = !0),
            e.getTipElement().classList.contains('show') || e._hoverState === 'show' ? e._hoverState = 'show' : (clearTimeout(e._timeout),
            e._hoverState = 'show',
        ...
        _leave(t, e) {
            e = this._initializeOnDelegatedTarget(t, e),
            t && (e._activeTrigger[t.type === 'focusout' ? 'focus' : 'hover'] = e._element.contains(t.relatedTarget)),
        ...
        _cleanTipClass() {
            const t = this.getTipElement();
            const e = t.getAttribute('class').match(It);
            e !== null && e.length > 0 && e.map((t) => t.trim()).forEach((e) => t.classList.remove(e));
        }
    ...
    class Wt extends jt {
        ...
        _cleanTipClass() {
            const t = this.getTipElement();
            const e = t.getAttribute('class').match(Ht);
            e !== null && e.length > 0 && e.map((t) => t.trim()).forEach((e) => t.classList.remove(e));
        }
    ...
    class Ft extends q {
        ...
        refresh() {
            ...
            const s = e === 'position' ? this._getScrollTop() : 0;
            this._offsets = [],
            this._targets = [],
            this._scrollHeight = this._getScrollHeight(),
            i.find(this._selector).map((t) => {
                const n = r(t);
                const o = n ? i.findOne(n) : null;
                if (o) {
        ...
        _process() {
            ...
            const s = this._config.offset + e - this._getOffsetHeight();
    ...
    class Ut extends q {
        ...
        show() {
            ...
            const s = this._element.closest('.nav, .list-group');
            if (s) {
                const e = s.nodeName === 'UL' || s.nodeName === 'OL' ? ':scope > li > .active' : '.active';
                t = i.find(e, s),
                t = t[t.length - 1];
            }
            ...
            if (B.trigger(this._element, 'show.bs.tab', {
                relatedTarget: t,
            }).defaultPrevented || n !== null && n.defaultPrevented) return;
        ...
        _activate(t, e, s) {
            const n = (!e || e.nodeName !== 'UL' && e.nodeName !== 'OL' ? i.children(e, '.active') : i.find(':scope > li > .active', e))[0];
            const o = s && n && n.classList.contains('fade');
            const r = () => this._transitionComplete(t, n, s);
        ...
        _transitionComplete(t, e, s) {
            if (e) {
                ...
                e.getAttribute('role') === 'tab' && e.setAttribute('aria-selected', !1);
            }
            ...
            let n = t.parentNode;
            if (n && n.nodeName === 'LI' && (n = n.parentNode),
